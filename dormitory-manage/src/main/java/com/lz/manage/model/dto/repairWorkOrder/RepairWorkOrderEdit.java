 ...
 */
@Data
public class RepairWorkOrderEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param repairWorkOrderEdit 编辑对象
     * @return RepairWorkOrder
     */
    public static RepairWorkOrder editToObj(RepairWorkOrderEdit repairWorkOrderEdit) {
        if (repairWorkOrderEdit == null) {
            return null;
        }
        RepairWorkOrder repairWorkOrder = new RepairWorkOrder();
        BeanUtils.copyProperties(repairWorkOrderEdit, repairWorkOrder);
        return repairWorkOrder;
    }
}
