  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="repairList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="问题内容" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible" prop="repairContent" />
        <el-table-column label="联系人" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible" prop="contactUser" />
        <el-table-column label="联系电话" :show-overflow-tooltip="true" align="center" v-if="columns[12].visible" prop="contactPhone" />
        <el-table-column label="完成时间" :show-overflow-tooltip="true" align="center" v-if="columns[13].visible" prop="completedTime" />
        <el-table-column label="处理费用" :show-overflow-tooltip="true" align="center" v-if="columns[14].visible" prop="dealWithCost" />
        <el-table-column label="备注" :show-overflow-tooltip="true" align="center" v-if="columns[15].visible" prop="remark" />
        <el-table-column label="处理人" :show-overflow-tooltip="true" align="center" v-if="columns[16].visible" prop="dealWithId" />
        <el-table-column label="创建人" :show-overflow-tooltip="true" align="center" v-if="columns[17].visible" prop="userId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="报修位置" prop="repairAddress">
          <el-input v-model="form.repairAddress" placeholder="请输入报修位置" />
        </el-form-item>
      ...
      <el-upload ref="upload" :limit="1" accept=".xlsx, .xls" :headers="upload.headers" :action="upload.url + '?updateSupport=' + upload.updateSupport" :disabled="upload.isUploading" :on-progress="handleFileUploadProgress" :on-success="handleFileSuccess" :auto-upload="false" drag>
        ...
        <div class="el-upload__tip text-center" slot="tip">
          <div class="el-upload__tip" slot="tip">
            <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的报修记录数据
          </div>
...
<script>
import { listRepair, getRepair, delRepair, addRepair, updateRepair, importRepair, importTemplateRepair } from "@/api/manage/repair";
import { getToken } from "@/utils/auth";

export default {
  name: "Repair",
  dicts: ['repair_type', 'repair_status', 'abnormal_status'],
  data() {
    return {
      //表格展示列
      columns: [
        { key: 0, label: '编号', visible: true },
          ...
          { key: 14, label: '处理费用', visible: true },
          { key: 15, label: '备注', visible: true },
          { key: 16, label: '处理人', visible: true },
  ...
  methods: {
    ...
    importTemplate() {
      ...
      }, `repair_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
