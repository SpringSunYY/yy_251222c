...
<script>
import {
  listDormitoryBedHistory,
  getDormitoryBedHistory,
  delDormitoryBedHistory,
  addDormitoryBedHistory,
  updateDormitoryBedHistory,
  importDormitoryBedHistory,
  importTemplateDormitoryBedHistory
} from "@/api/manage/dormitoryBedHistory";
...
export default {
  ...
  methods: {
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download(this.upload.templateUrl, {}, `dormitoryBedHistory_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
