  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="repairWorkOrderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        <el-table-column label="报修" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="repairId" />
        ...
        <el-table-column label="维修工" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="dealWithId" />
        <el-table-column label="处理时间" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="dealWithTime" />
        <el-table-column label="处理费用" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="dealWithCost" />
        <el-table-column label="处理内容" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="dealWithContent" />
        ...
        <el-table-column label="完成时间" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="completedTime" />
      ...
      <el-upload ref="upload" :limit="1" accept=".xlsx, .xls" :headers="upload.headers" :action="upload.url + '?updateSupport=' + upload.updateSupport" :disabled="upload.isUploading" :on-progress="handleFileUploadProgress" :on-success="handleFileSuccess" :auto-upload="false" drag>
        ...
        <div class="el-upload__tip text-center" slot="tip">
          <div class="el-upload__tip" slot="tip">
            <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的维修工单数据
          </div>
...
<script>
import { listRepairWorkOrder, getRepairWorkOrder, delRepairWorkOrder, addRepairWorkOrder, updateRepairWorkOrder, importRepairWorkOrder, importTemplateRepairWorkOrder } from "@/api/manage/repairWorkOrder";
...
export default {
  ...
  methods: {
    ...
    importTemplate() {
      ...
      }, `repairWorkOrder_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
