  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dormitoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="人数限制" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="peopleNumberLimit" />
        <el-table-column label="宿舍人数" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="peopleNumber" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="人数限制" prop="peopleNumberLimit">
          <el-input v-model="form.peopleNumberLimit" placeholder="请输入人数限制" />
        </el-form-item>
        <el-form-item label="宿舍人数" prop="peopleNumber">
          <el-input v-model="form.peopleNumber" placeholder="请输入宿舍人数" />
        </el-form-item>
...
<script>
import { listDormitory, getDormitory, delDormitory, addDormitory, updateDormitory, importDormitory, importTemplateDormitory } from "@/api/manage/dormitory";
