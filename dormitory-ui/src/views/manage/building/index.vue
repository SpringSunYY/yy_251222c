    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['manage:building:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['manage:building:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['manage:building:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['manage:building:import']"
        >导入</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['manage:building:export']"
        >导出</el-button>
      </el-col>
      ...
      <el-upload ref="upload" :limit="1" accept=".xlsx, .xls" :headers="upload.headers" :action="upload.url + '?updateSupport=' + upload.updateSupport" :disabled="upload.isUploading" :on-progress="handleFileUploadProgress" :on-success="handleFileSuccess" :auto-upload="false" drag>
        ...
        <div class="el-upload__tip text-center" slot="tip">
          <div class="el-upload__tip" slot="tip">
            <el-checkbox v-model="upload.updateSupport" />是否更新已经存在的楼栋信息数据
          </div>
...
<script>
import { listBuilding, getBuilding, delBuilding, addBuilding, updateBuilding, importBuilding, importTemplateBuilding } from "@/api/manage/building";
...
export default {
  ...
  data() {
    return {
      ...
      form: {},
      // 导出地址
      exportUrl: 'manage/building/export',
      // 楼栋信息导入参数
      upload: {
        // 是否显示弹出层（楼栋信息导入）
        open: false,
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/manage/building/importData",
        // 下载模板的地址
        templateUrl: 'manage/building/importTemplate'
      },
      // 表单校验
      rules: {
        name: [
  ...
  methods: {
    ...
    /** 导入按钮操作 */
    handleImport() {
      this.upload.title = "楼栋信息导入";
      this.upload.open = true;
    },
    /** 下载模板操作 */
    importTemplate() {
      this.download(this.upload.templateUrl, {
      }, `building_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
